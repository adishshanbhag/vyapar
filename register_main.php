...
<html lang="en" dir="ltr">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
        <a href="user_signup.php">  <img src="img/businessman.png" class="ma"alt="Shop"></a>
          <h2 class="m">User signup</h2>
        </div>
        <div class="col-sm-6">
        <a href="shopssignup.php"><img src="img/laptop.png" class="ma" alt="User"></a>
          <h2 class="m">Shop signup</h2>
        </div>
      </div>
    </div>
  </body>
